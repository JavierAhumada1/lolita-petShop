...
import DataUserProfile from '../Components/DataUser/DataUserProfile';
  ...
  return (
    <div className="min-h-[70vh] w-full flex justify-around py-2 px-2 font-nunito gap-4">
      <div className="w-[40rem] flex justify-between items-center">
        <div className="h-full w-full bg-light-grey flex flex-col gap-5 p-3 items-start justify-around">

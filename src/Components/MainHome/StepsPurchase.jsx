    ...
    return (
        <>
            <div className="font-nunito flex flex-col py-5">
                <h2 className='bg-black rounded-2xl text-white text-2xl font-bold uppercase self-center py-2 px-20'>Tu compra en <span className="text-orange">3 pasos</span></h2>
                <div className='flex justify-evenly pt-5'>
                    {steps.map(step => (
                        <div className='flex flex-col items-center px-2' key={step.id}>

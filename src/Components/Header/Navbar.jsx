            ...
            <div className="relative flex h-16 items-center justify-between">
                      ...
                      <Linkrouter
                        ...
                        className={classNames(
                          item.current
                            ...
                            : "text-white hover:bg-gray-700 hover:text-orange",
              ...
              <div className="absolute inset-y-5 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-2 right-1 left-2">
                ...
                <Menu as="div" className="relative ml-3">
                  ...
                  >
                    {user?._id ? (
                      <Menu.Items className="absolute right-0 z-10 mt-2 w-52 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-white ring-opacity-5 focus:outline-none">
                        <Menu.Item>
                          {({ active }) => (
                            <Linkrouter
                              to="/mi-cuenta"
                            ...
                            >
                              {user?.name ? user.name : 'Bienvenido'}
                            </Linkrouter>
                          )}
                        </Menu.Item>
                        <Menu.Item>
